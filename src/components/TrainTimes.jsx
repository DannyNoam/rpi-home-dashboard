...
import { calculateMinutesUntilArrival, formatTimePart } from '../util/timeUtils.js';
...
export default React.createClass({
	...
	componentDidMount: function () {
		pollFor(() => { this._getTrainData() }, this.props.refreshRate);
	},
	...
	_getTrainData: function (endpoint) {
