    ...
    return (
      <div className="middle-components">
        ...
        <div className="right-side-components">
          ...
          <List refreshRate={ refreshRates.LIST } label="Shopping List" type="shopping"
                endpoint={ Endpoints.SHOPPING_LIST } editKey="s"/>
          <List refreshRate={ refreshRates.LIST } label="To Do List" type="todo" endpoint={ Endpoints.TODO_LIST }
                editKey="t"/>
        </div>
      </div>
    );
